      ...
      <div class="content">
        <div class="container-fluid">
          <?php renderComponent("crudtable", [
            ...
            "pageDescription" => "Gestiona tu cartera de clientes, consulta sus datos fiscales y de contacto, y administra sus límites de crédito",
            ...
            "filters" => [
              [
                ...
                "label"       => "Buscar aquí",
                "type"        => "input",
                "placeholder" => "Cliente, Correo, Teléfono...",
              ]
            ]
          ]); ?>
        </div>

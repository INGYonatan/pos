...
$page_config = [
  'page_title'      => 'Facturas de traspaso',
  'page_identifier' => 'facturas-traspaso'
];

checkModuleActionPermission($page_config['page_identifier'], 'ver', true);

$inventoryTransferId = $_GET["inventoryTransferId"] ? cleanStr($_GET["inventoryTransferId"]) : "";
?>
      ...
      <div class="content">
        <div class="container-fluid">
          <?php renderComponent("crudtable", [
            ...
            "extraHtmlInFilters" => $inventoryTransferId ? <<<HTML
              <input name="inventoryTransferId" value="{$inventoryTransferId}" type="hidden">
            HTML : "",
            "filters" => [
              [
                "name"        => "search",

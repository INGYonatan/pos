        ...
        <div class="col-md-8 col-lg-6 col-xl-4">
          <div class="card">
            <div class="card-body p-4">
              <div class="text-center w-75 m-auto">
                <div class="auth-logo">
                  <a href="<?= BASE_URL; ?>" class="logo logo-dark text-center">
                    <span class="logo-lg">
                      <img src="<?= ADM_LOGO; ?>" alt="" height="50">
                    </span>
                  </a>
                ...
                <p class="text-muted mb-4 mt-3">Ingresa tus correo electrónico para continuar.</p>
              </div>
              ...
              <form id="login-form" class="form-validate" autocomplete="off">
                ...
                <input name="action" type="hidden" value="recuperar-credenciales">
                <input name="place" type="hidden" value="authentication">

                <div class="d-grid mb-0 text-center">
                  <button class="btn btn-primary" type="submit"> Recuperar credenciales </button>
                </div>
              </form>
          ...
          <div class="row mt-3">
            <div class="col-12 text-center">
              <p> <a href="login" class="text-muted ms-1">Ir a login</a></p>
            </div>
          </div>
          <!-- end row -->

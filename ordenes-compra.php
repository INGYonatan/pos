...
$page_config = [
  ...
  'page_identifier'   => 'ordenes-compra',
  'modal_title_add'   => '',
  'modal_title_edit'  => ''
];
      ...
      <div class="content">
        <div class="container-fluid">
          <?php renderComponent("crudtable", [
            ...
            "pageDescription" => "Gestiona tus órdenes de compra activas y conviértelas en compras completadas.",
            ...
            "filters" => [
              "principal" => [
                [
                  ...
                  "label"       => "Buscar aquí",
                  "type"        => "input",
                  "placeholder" => "Folio, " . ($IS_ADMIN ? "Sucursal, " : "") . "Realizó, Total...",
                ],
                [
                  "field"  => "render",

...
require 'data/lib/helpers/purchases.helper.php';

$purchase_id = cleanStr($_GET['uid']);
...
$cart         = purchase_create_cart_edit($purchase_id);
                  ...
                  <div class="row">
                    <div class="col-12 col-md-6">
                      <div class="form-group">
                        ...
                        <input id="folio_documento" class="form-control" name="folio_documento" value="<?= $purchase->document_folio; ?>" type="text" required>
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input id="fecha_documento" class="form-control datepicker" name="fecha_documento" value="<?= $purchase->document_date_format; ?>" type="text" required>
                    ...
                    <div class="col-12 col-md-6">
                      <div class="form-group">
                        ...
                        <select id="metodo_pago" class="form-control form-select" name="metodo_pago" required>
                          <option <?= $purchase->payment_method === 'De contado' ? 'selected' : false; ?> value="De contado">De contado</option>
                          <option <?= $purchase->payment_method === 'Credito' ? 'selected' : false; ?> value="Credito">Credito</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                      <div class="form-group">
                        ...
                        <select id="forma_pago" class="form-control form-select" name="forma_pago" required>
                          <option value="Efectivo" <?= $purchase->payment_form === 'Efectivo' ? 'selected' : ''; ?>>Efectivo</option>
                        </select>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <select id="id_proveedor" class="form-control form-select supplier-catalog" name="id_proveedor" required>
                            <?= getSupplierCatalog($purchase->supplier_id); ?>
                          </select>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        <textarea id="observaciones" class="form-control" name="observaciones" rows="3"><?= $purchase->observations; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>

    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td>
            <a href="<?= BASE_URL; ?>/download?uid=<?= CARPETA_FACTURAS_ANTICIPO_DE_COMPRA_URL ?>/<?= $row['uuid']; ?>.xml">
              <i class="fa fa-file text-primary"></i> Archivo XML
            </a>
            <br>
            <a href="<?= BASE_URL; ?>/download?uid=<?= CARPETA_FACTURAS_ANTICIPO_DE_COMPRA_URL ?>/<?= $row['uuid']; ?>.pdf">

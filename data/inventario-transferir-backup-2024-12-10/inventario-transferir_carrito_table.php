    ...
    <table class="table table-sm">
      <thead>
        <tr class="table-dark">
          ...
          <th>Stock origen final</th>
          <th style="width: 8rem;">Cantidad</th>
          <th>Stock destino final</th>
        </tr>
      </thead>
      <tbody>
        ...
        ?>
          <tr class="pos-tr">
            ...
            <td>
              <?= $row['stock_origen']; ?> <?= $unit_type; ?>
            </td>

            <td>
              <span id="new-stock-origin-label-<?= $row['id_producto']; ?>"><?= ($row['stock_origen'] - doubleval($row['cantidad'])); ?></span> <?= $unit_type; ?>
            </td>
            ...
            <td>
              <span id="new-stock-destiny-label-<?= $row['id_producto']; ?>"><?= ($row['stock_destino'] + $row['cantidad']); ?></span> <?= $unit_type; ?>
            </td>

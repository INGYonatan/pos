  ...
  <table cellspacing="0" cellpadding="1" border="0">
    <tbody>
      <tr>
        ...
        <td class="description" style="width: 12%; text-align: right;">ORDEN</td>
        <td class="description-sm" style="width: 12%; text-align: right;"><?= $purchaseOrder->folio; ?></td>
      </tr>

      <tr>
        <td class="description" style="background-color: #444; text-align: right; color: #fff;"><span style="text-transform: uppercase;">COMPRA</span></td>
      </tr>
    </tbody>
  </table>
  ...
  <table cellspacing="0" cellpadding="1" border="0">
    <tbody>
      <tr>
        ...
        <td class="description" style="text-align: right;"><?= $purchaseOrder->created_date_format; ?></td>
      </tr>

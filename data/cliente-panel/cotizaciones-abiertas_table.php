              ...
              <div class="btn-group dropstart">
                ...
                <div class="dropdown-menu">
                  <?php if (checkModuleActionPermission('editar-cotizacion', 'editar')) : ?>
                    <a class="dropdown-item" href="<?= BASE_URL; ?>/editar-cotizacion.php?uid=<?= $row['id_cotizacion']; ?>&rollback=cliente/<?= $row['id_cliente']; ?>/cotizaciones-abiertas">
                      <i class="fa fa-pencil-alt"></i> Editar
                    </a>
                  <?php endif; ?>

                  <?= getTableActions($cotizaciones_abiertas_tid, $row, [
                    'cancelar' => [

    ...
    <table class="table table-sm table-hover">
      ...
      <tbody>
        <?php foreach ($carrito as $key => $row) :
          ...
          $typeId         = $row['id_tipo'];
          $type           = $row['tipo'];
          $requires_serial_number = $row['requiere_numero_serie'];
        ...
        ?>
          <tr class="pos-tr">
            ...
            <td>
              <div class="form-group mb-0">
                <div class="input-group input-group-sm">
                  <input id="price-<?= $id ?>" class="form-control form-control-sm decimal-input cart-row-input" name="precio_costo" value="<?= $price; ?>" data-itemId="<?= $id; ?>" step="0.0001" type="number" autocomplete="off">
            ...
            <td class="text-center">
              <div class="input-group input-group-sm">
                <input id="discount-<?= $id ?>" class="form-control form-control-sm decimal-input cart-row-input" name="discount" value="<?= $discount; ?>" data-itemId="<?= $id; ?>" data-limit="<?= $discount_limit; ?>" min="0" max="<?= $discount_limit; ?>" step="0.0001" type="number" autocomplete="off" <?= $discount_limit == 0 ? 'readonly' : ''; ?>>
                <div class="input-group-text">%</div>
              </div>
            </td>

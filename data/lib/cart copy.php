...
class Cart
{
  ...
  private function define_product_totals()
  {
     ...
     */
    $product_cost                   = $have_iva ? $this->get_price_without_iva($product->cost_price)  : $product->cost_price;
    $product_cost_iva               = $have_iva ? $this->get_price_iva($product->cost_price)          : 0;
    ...
    $product->cost_without_iva      = $product_cost;
    $product->cost_iva              = $product_cost_iva;
    $product->cost_total_iva        = $product_cost_total_iva;
    $product->cost_amount           = $product_cost_amount;
    $product->cost_amount_with_iva  = $product_cost_amount_with_iva;

    /**
     * Definir el importe precio venta (sale_amount) en el producto
     */
    $product_sale                   = $have_iva ? $this->get_price_without_iva($product->sale_price)  : $product->sale_price;
    $product_sale_discount          = $this->parse_discount_percentage($product_sale, $product->discount);
    $product_sale                   = $product_sale - $product_sale_discount;

    $product_sale_iva               = $have_iva ? $this->get_price_iva($product->sale_price)          : 0;
    $product_sale_total_iva         = $product_sale_iva * $quantity;
    $product_sale_amount            = $product_sale * $quantity;
    $product_sale_amount_with_iva   = $product_sale_amount + $product_sale_total_iva;

...
switch ($action) {
  ...
  case "cart-update-item-quantity-{$identifier}";
    ...
    if ($response->status === 'success') :
      ...
      $precio_neto    = number_format($product->sale_price - $product->sale_iva, DECIMALS_CURRENCY);
      ...
      $response->precio_venta_no_format  = $precio_venta;
      $response->precio_venta_in = $precio_neto;
    endif;
    break;

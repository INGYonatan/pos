...
$page_config = [
  ...
  'page_identifier'   => 'proveedores',
  'modal_title_add'   => 'Agregar proveedor',
  'modal_title_edit'  => 'Editar proveedor'
];
      ...
      <div class="content">
        <div class="container-fluid">
          <?php renderComponent("crudtable", [
            ...
            "pageDescription" => "Administra tu catálogo de proveedores, actualiza sus datos de contacto y gestiona tu red comercial",
            ...
            "filters" => [
              "principal" => [
                [
                  ...
                  "label"       => "Buscar aquí",
                  "type"        => "input",
                  "placeholder" => "Proveedor, Nombre comercial, Correo, Teléfono...",
                ]
              ]
            ]
          ]); ?>

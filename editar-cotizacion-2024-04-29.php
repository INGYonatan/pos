...
if (!$quote_id || !$rollback || ($rollback != 'cotizaciones-abiertas' && $rollback != 'cotizaciones-cerradas')) :
  closeSession();
  die;
endif;
              ...
              <form id="<?= $page_config['page_identifier']; ?>-form-data" class="card adm-card-fh" autocomplete="off">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                      <div class="form-group">
                        ...
                        <select id="tipo" class="form-control form-select" name="tipo" required disabled>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-group">
                        <?php $data_cliente = mysqli_fetch_assoc(mysqli_query($mysqli, "SELECT id_cliente, nombre_completo FROM {$db_dti}_clientes WHERE id_cliente = {$cart->customer_id} ORDER BY id_cliente ASC LIMIT 1")); ?>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        <textarea id="observaciones" class="form-control" name="observaciones" rows="3"><?= $cart->observations; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>

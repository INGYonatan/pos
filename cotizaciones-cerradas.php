...
$page_config = [
  'page_title'        => 'Cotizaciones cerradas',
  'page_identifier'   => 'cotizaciones-cerradas',
  'modal_title_add'   => '',
  'modal_title_edit'  => ''
];
...
<body class="loading">
  ...
  <div id="wrapper">
    ...
    <div class="content-page">
      <div class="content">
        <div class="container-fluid">
          <?php renderComponent("crudtable", [
            ...
            "pageDescription" => "Gestiona tus cotizaciones cerradas, registra anticipos y conviértelas en ventas.",
            ...
            "filters" => [
              "principal" => [
                [
                  ...
                  "label"       => "Buscar aquí",
                  "type"        => "input",
                  "placeholder" => "Folio, " . ($IS_ADMIN ? "Sucursal, " : "") . "Cliente, Realizó, Total...",
                ],
                [
                  "field"  => "render",
                ...
                [
                  ...
                  "selectOptions" => [
                    ["value" => "", "label" => "--Todos--"],
                    ["value" => "vigente", "label" => "Vigente", "selected" => true],
      ...
      <!-- MODALS -->
      <?php include 'src/modals/cotizaciones.php'; ?>
      <?php include 'src/modals/cotizaciones-cerradas.php'; ?>
  ...
  <script>
    $(document).on('click', '.btn-ver-productos', function() {
      ...
      $(`#${PAGE_CONFIG.page_identifier}-tabla-ver-productos`).html(productos);
    });

...
$page_config = [
  ...
  'page_identifier'   => 'sucursales',
  'modal_title_add'   => 'Agregar sucursal',
  'modal_title_edit'  => 'Editar sucursal'
];
      ...
      <div class="content">
        <div class="container-fluid">
          <?php renderComponent("crudtable", [
            ...
            "pageDescription" => "Administra tus sucursales y almacenes, actualiza su información de contacto y controla su configuración",
            ...
            "filters" => [
              [
                ...
                "label"       => "Buscar aquí",
                "type"        => "input",
                "placeholder" => "Sucursal, Teléfono, Dirección...",
              ]
            ]
          ]); ?>
        </div>

...
<div class="modal fade" id="<?= $page_config['page_identifier']; ?>-modal-convertir-a-compra" tabindex="-1" role="dialog" aria-labelledby="<?= $page_config['page_identifier']; ?>-modal-label" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="<?= $page_config['page_identifier']; ?>-convertir-a-compra-form-data" class="modal-content form-validate" autocomplete="off">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="<?= $page_config['page_identifier']; ?>-modal-label-convertir-a-compra">Convertir a compra</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
        ...
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <select id="id_sucursal" class="form-select form-select" name="id_sucursal" required>
                <?= getBranchOfficesCatalog(null, '--Seleccionar--', true, false); ?>
              </select>
            </div>
          </div>
